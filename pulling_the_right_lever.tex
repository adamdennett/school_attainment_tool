...
of those catchments exacerbated by the open-allocation policy. That the
central catchments were perceived to be more `middle-class' and the
peripheral schools in the East of the city (in particular) perceived to
be more `working-class' may have also factored into this policy design.
...
were rejected. And under pressure from a negative public response to the
council proposals the 20\% out-of-catchment priority was reduced to 5\%.

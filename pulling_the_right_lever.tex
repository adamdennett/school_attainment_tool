...
England's secondary schools. The shaded cloud shows the national
distribution; the orange dots highlight Brighton and Hove's ten
secondaries to give a first sense of where the city sits within the
wider system. A dense cluster around the origin is the typical case ---
most schools nationally sit close to their intake-predicted attainment
with attendance close to what their intake predicts. The interesting
cases are the schools furthest from the origin, in any direction.
...
plane into the four narrative quadrants discussed in the text.}

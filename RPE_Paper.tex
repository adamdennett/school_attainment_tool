...
explained, with the t-values (in some respects a standardised version of
the coefficients allowing for a degree of relative comparison) showing
that \% absence (t = -60.5) is the most important variable, mean KS2
prior attainment (t = 58.2) the next most important and \% FSM the least
influential (t = -21.0).

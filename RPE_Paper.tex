...
and for the final year of our panel no observed prior-attainment data
exists at all. This is a hard data constraint rather than a modelling
preference. Because the KS2 tests and assessments of 2019-20 and 2020-21
were cancelled during the pandemic, the cohorts reaching the end of KS4
in 2024-25 and 2025-26 have no KS2 results of any kind; the DfE
...
observed low-prior-attainment share (or, where that is unavailable, its
mean across observed years), and the affected rows are flagged in the
panel. We use the low-prior-attainment share rather than the mean KS2
score because it is the measure our models require and the one we can
carry forward on a consistent basis; both are equally absent in 2024-25.
As a robustness check, we refit the models on the three-year sub-sample
where prior attainment is genuinely observed, adding the mean KS2 scaled
score alongside the low-prior-attainment share; the absence coefficient

...
::: incremental
- Persistent school effect ≈ **`r afr$decomp_dis[["Share of total %"]][afr$decomp_dis$Component == "School (persistent, unexplained)"]`%** ≈ `r afr$decomp_dis[["~Attainment 8 points"]][afr$decomp_dis$Component == "School (persistent, unexplained)"]` Att8 points per SD — *an upper bound, including catchment sorting*
- The hand each school is dealt ≈ **`r afr$decomp_dis[["Share of total %"]][grepl("Fixed", afr$decomp_dis$Component)]`%**
- **Moving children between schools redistributes the small component — not the big ones**
:::

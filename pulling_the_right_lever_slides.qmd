...
- **The settled consensus** (Teddlie & Reynolds, 2000): school effects are real but a minority share — commonly **10–20%** of pupil-level attainment variance; intake and context carry the rest
...
::: key-finding
"Context outweighs school" is a sixty-year-old finding — what has been missing is a way to make it **usable**. This work makes the decomposition open, reproducible, cross-phase and *local* — and later in this deck, puts today's numbers on it.
:::

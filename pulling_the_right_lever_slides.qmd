...
## Neighbourhood effects (2)
::: incremental
- When neighbourhood effects added to the full national model: prior attainment, disadvantage, absence, workforce, Ofsted **all already controlled**
- **Neighbourhood effects survive** — neighbourhood adult education statistically significant; marginal R² `r sprintf('%.2f', afr$r2$base_marginal)` → `r sprintf('%.2f', afr$r2$census_marginal)`

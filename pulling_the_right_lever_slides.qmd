...
That **`r sch_share`%** share (for **disadvantaged pupils**) is a *residual* — what a school adds **after the model has already stripped out its intake, prior attainment, absence and neighbourhood**. It converts to **`r sch_pts` Attainment 8 points per standard deviation** between schools.

::: incremental
- **"1 SD above average" means:** once everything measurable is accounted for, this school's disadvantaged pupils still do **~`r sch_pts` points better** than the typical school — about **a quarter-to-a-third of a grade in every subject**, or a **full grade in 2–3 subjects**
- **An excellent school** (2 SD, ~top 2.5%): **~`r sch_pts2` points**
- **Bigger than the lever the whole debate was about** — social-mixing was worth ~1–2 points (and *not* for disadvantaged pupils); on par with an effective head [@Zuccollo2023] or strong teaching [@Slater2012]
- **BACA *is* that school:** **+`r baca_4yr` Att8 points** for its disadvantaged pupils over four years (**~`r baca_sd` SD** above average), rising to **+`r baca_latest`** in 2024–25 — genuinely top-of-distribution *after* accounting for its tough intake
:::

:::: fragment
::: key-finding
This is a *floor, not a ceiling* — the spread **between** schools with identical intakes. It is exactly the effect that made **BACA the city's strongest school for disadvantaged pupils**, even while raw league tables and a 'requires improvement' Ofsted said otherwise.
:::
::::

...
::: incremental
- Census 2021 at **output-area** level: adult education (% level 4+), unemployment, inactivity — averaged over each school's **50 nearest OAs**
...
- Wider neighbourhoods fit better at KS4 (k = 50 \> 25 \> 10) — secondary catchments are *visible in the data*
- Crucially: **the absence coefficient barely moves** — the headline finding is not a neighbourhood artefact
:::

## What does a "50-nearest-neighbourhood" actually look like?

![](slides_assets/dorothy_stringer_50oa.png){fig-align="center" height="470"}

::: {style="font-size:0.55em; text-align:center; color:#555; margin-top:0.1em;"}
Pink diamond = **Dorothy Stringer School**; purple dots = its 50 nearest Output Area centroids — a walkable ~1 km of local social fabric.
:::

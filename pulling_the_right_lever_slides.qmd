...
optionZ <- st_read(
  "E:/BH_Schools_Consultation/data/optionZ_Mar25.geojson", quiet = TRUE
) %>% st_transform(4326)
...
::: {.key-finding}
Parents, acting rationally on available information, were actively choosing the school with *lower* value-added for their children. They were operating in a **knowledge vacuum**.
:::
...
- Our analysis: this is **at best incomplete**, at worst **fundamentally flawed**
...
## Second-order effects: when the cure worsens the malady
...
::: {.key-finding}
A policy that even marginally increases absence could be **counterproductive** in attainment terms. The claim of "almost no cost" for social mixing is false when implemented through displacement.
:::

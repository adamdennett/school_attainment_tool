...
e.g.~reduced sleep and its psychosocial (Fredriksen et al. 2004; Yeo et
al. 2019), physical (Voulgaris et al. 2019; Pradhan and Sinha 2017;
Pereira et al. 2014; Faulkner et al. 2013) and mental health (Nakajima
et al. 2024; Chairassamee et al. 2024; Guan et al. 2025) including
stress (Karan et al. 2021) and general wellbeing (Ding et al. 2023) -
they are also associated with higher absence in many countries (Otsuka
et al. 2025; Cordes et al. 2022; Blagg et al. 2018) including England
(Thomson 2023) --- precisely the factor that most drags on attainment
and the biggest problem already besetting Brighton and Hove. The council
could be imposing policies that actively make the outcomes for
disadvantaged children much worse through failing to engage with the
...
The authors used Anthropic's Claude Code (Claude Sonnet 4.5) to assist
...
Quarto outputs. Any analytical decisions, interpretations, and written
content were reviewed, verified and approved by the authors, who take

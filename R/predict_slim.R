# predict_slim.R - Lightweight prediction from extracted model components
# -----------------------------------------------------------------------
# Replaces lme4::predict() for the Shiny app so we don't need the 55MB+
# lme4 model objects at runtime.
#

...
in the city was \emph{`driven by economic advantage'} --- a framing
that, in the Brighton and Hove context specifically, has been
empirically challenged by Tan and Dennett (2025). This built on a 2023
policy giving FSM-eligible pupils priority in admissions at schools with
below the city-average (30\%) FSM share, which was already producing
flows from peripheral to more popular central catchments.

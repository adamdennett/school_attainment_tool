...
panel %>%
  ...
  scale_fill_manual(values = c(AAR = "#2c7bb6", CFR = "#d7191c"), name = "Source") +
...
panel_fin %>%
  ...
  scale_fill_manual(values = c(AAR = "#2c7bb6", CFR = "#d7191c"), guide = "none") +
...
panel_fin %>%
  ...
  scale_x_continuous(labels = label_comma(prefix = "\u00A3")) +
  scale_colour_manual(values = c(AAR = "#2c7bb6", CFR = "#d7191c"), name = "Source") +
...
panel_fin %>%
  ...
  geom_point(alpha = 0.3, size = 1.5, colour = "steelblue") +
  geom_smooth(method = "loess", se = TRUE, colour = "black", linewidth = 1) +
  scale_x_continuous(labels = percent) +
...
panel_fin %>%
  ...
  geom_point(alpha = 0.3, size = 1.5, colour = "darkorange") +
  geom_smooth(method = "loess", se = TRUE, colour = "black", linewidth = 1) +
  scale_y_continuous(labels = label_comma(prefix = "\u00A3")) +

...
admissions priority for FSM-eligible pupils across its community
schools. In 2024, the council launched proposals to reduce Published
Admission Numbers at popular central-catchment schools, reserve places
for out-of-catchment children in those catchments ahead of in-catchment
children, and redraw catchment boundaries. The proposals were promoted
on the premise that attainment in the city was `driven by economic
advantage' and that redistributing pupils would narrow the attainment
gap. The response was overwhelmingly negative, yet parents and schools
lacked the tools to challenge the proposals effectively and the core
policy direction persisted, albeit slightly watered down.
...
economic advantage'} --- a characterisation challenged in this context
by Tan and Dennett (2025). This built on a 2023 policy giving
FSM-eligible pupils priority at schools below the city-average (30\%)
FSM share, which was already producing flows from peripheral to central
catchments.

...
- **Disadvantage** (FSM): some residual effect remains after accounting for above. Gap narrowed post-2011, reversed post-COVID

- **Workforce**: leadership quality, teacher retention, and teacher sickness matter — especially for disadvantaged pupils

- **Selectivity**: creams-off rather than improves - grammar school premium largely disappears after SES controls
...
::: {.key-finding}
Parents, acting rationally on available information, may have been choosing a **worse option** for their children's attainment — if value-added is the most important factor. This is the cost of an intelligence gap.
:::

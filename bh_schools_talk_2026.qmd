...
## Brighton Aldridge: the local example {.smaller}
...
::: key-finding
Brighton Aldridge is **last of ten** on the headline measure and **`r ordinal(rank(-cd$va)[cd$short == "Brighton Aldridge"])`** on value added. Changing the guidance, and publishing a contextualised measure beside the headline, would cost nothing.
:::
...
acc_sf <- lsoa |>
  ...
  dplyr::mutate(site = factor(ifelse(site == "places_30", "Longhill at Ovingdean (today)",
                                     "Longhill at the top of Elm Grove"),
